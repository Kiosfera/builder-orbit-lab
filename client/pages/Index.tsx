            ...
            {nurseryStatus.map((farm, index) => (
              <div key={index} className="space-y-2">
                ...
                <div className="flex justify-between text-xs text-muted-foreground">
                  ...
                  <span>Ocupação: {Math.round((farm.active / farm.total) * 100)}%</span>
                </div>
              </div>
            ))}
          </CardContent>
              ...
              {recentActivity.map((activity, index) => (
                <div key={index} className="flex items-start gap-3">
                  <div className={`mt-1 p-1 rounded-full ${
                    ...
                    {activity.status === 'info' && <Package className="h-3 w-3" />}
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link to="/farm" className="block">
              <Button variant="outline" className="w-full h-20 flex-col gap-2">
                <Building2 className="h-6 w-6" />
                <span>Cadastrar Fazenda</span>
              </Button>
            </Link>
            <Link to="/stocking" className="block">
              <Button variant="outline" className="w-full h-20 flex-col gap-2">
