...
export default function Inventory() {
  ...
  const categories = [
    { id: 'feed', name: 'Ração', icon: '🐟', color: 'bg-blue-100 text-blue-800' },
    { id: 'medicine', name: 'Medicamentos', icon: '💊', color: 'bg-red-100 text-red-800' },
    { id: 'supplements', name: 'Suplementos', icon: '🧪', color: 'bg-green-100 text-green-800' },
    { id: 'equipment', name: 'Equipamentos', icon: '⚙️', color: 'bg-gray-100 text-gray-800' },
    { id: 'chemicals', name: 'Produtos Químicos', icon: '🧊', color: 'bg-purple-100 text-purple-800' },
    { id: 'maintenance', name: 'Manutenção', icon: '🔧', color: 'bg-yellow-100 text-yellow-800' }
  ]
  ...
  const criticalItems = inventoryItems.filter(item => item.currentStock <= item.minStock * 0.5).length
    ...
    <div className="space-y-6">
          ...
          <Dialog open={isLinkUsageOpen} onOpenChange={setIsLinkUsageOpen}>
            ...
            <DialogContent className="sm:max-w-[600px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Registre o uso de insumos vinculado a viveiros/lotes específicos
                </DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="feed35">Ração 35% Proteína</SelectItem>
                        <SelectItem value="feed32">Ração 32% Proteína</SelectItem>
                        <SelectItem value="probiotic">Probiótico Aqua Plus</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="grid gap-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="a1">Viveiro A-1 (LT-2024-001)</SelectItem>
                        <SelectItem value="a2">Viveiro A-2 (LT-2024-003)</SelectItem>
                        <SelectItem value="b1">Viveiro B-1 (LT-2024-002)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="grid gap-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="usage-quantity" placeholder="24.5" step="0.1" type="number" />
                  </div>
                  <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea id="usage-notes" placeholder="Notas sobre o uso, condições, resultados..." />
                </div>
              </div>
              <DialogFooter>
            ...
            <DialogContent className="sm:max-w-[400px]">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea id="cat-description" placeholder="Descrição da categoria..." />
                </div>
              </div>
              <DialogFooter>
                <Button type="submit" onClick={() => setIsAddCategoryOpen(false)}>
                  Criar Categoria
                </Button>
              </DialogFooter>
            </DialogContent>
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="entry-product" placeholder="Ex: Ração 35% Proteína Premium" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="entry-location" placeholder="Ex: Galpão A - Setor 1" />
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-4">
                  <div className="grid gap-2">
                    <Label htmlFor="entry-quantity">Quantidade</Label>
                    <Input id="entry-quantity" placeholder="1000" type="number" />
                  </div>
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="entry-unit-cost" placeholder="4.25" step="0.01" type="number" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    <Label htmlFor="entry-min-stock">Estoque Mínimo</Label>
                    <Input id="entry-min-stock" placeholder="500" type="number" />
                  </div>
                  <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea id="entry-notes" placeholder="Notas sobre a entrada, qualidade, condições..." />
                </div>
              </div>
              <DialogFooter>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">R$ {(totalInventoryValue / 1000).toFixed(0)}K</div>
                ...
                <TableBody>
                  {stockEntries.map((entry) => (
                    <TableRow key={entry.id}>
                      ...
                      <TableCell className="font-medium">R$ {entry.totalCost.toLocaleString()}</TableCell>
                ...
                <TableBody>
                  {usageLinkedToNurseries.map((usage) => (
                    <TableRow key={usage.id}>
                      ...
                      <TableCell className="font-medium">{usage.item}</TableCell>
                      <TableCell>
                        <div>
                          <p className="font-medium">{usage.nursery}</p>
                          <p className="text-xs text-muted-foreground">{usage.lot}</p>
                        </div>
                      </TableCell>
                      ...
                      <TableCell className="text-sm">{usage.operator}</TableCell>
                ...
                {categories.map((category) => (
                  <div key={category.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge className={category.color}>
                        {inventoryItems.filter(item => item.category === category.id).length}
                      </Badge>
                    </div>
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Itens em baixa:</span>
                        <span className="font-medium">
                          {inventoryItems
                            .filter(item => item.category === category.id && item.currentStock <= item.minStock)
                            .length}
                        </span>
                      </div>
                    </div>
