...
export default function Tasks() {
  ...
  const tasks = [
    ...
    },
    {
      ...
      dueTime: "16:30",
      nursery: "Viveiro C-1",
      description: "Verificar comportamento após alta mortalidade",
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Dr. Ana Costa</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Taxa: 75%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">4</div>
            <p className="text-xs text-muted-foreground">Sistema gerenciado</p>
          </CardContent>
        </Card>
      </div>
                ...
                <TableBody>
                  {tasks.map((task) => (
                    <TableRow key={task.id}>
                      ...
                      <TableCell>{getTaskBadge(task.type)}</TableCell>
