  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Qualidade da Água</h1>
        ...
        <div className="flex gap-3 mt-4 lg:mt-0">
          <Dialog open={isAddReadingOpen} onOpenChange={setIsAddReadingOpen}>
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="oxygen" placeholder="6.8" step="0.1" type="number" />
                  </div>
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="temperature" placeholder="28.2" step="0.1" type="number" />
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-4">
                  <div className="grid gap-2">
                    <Label htmlFor="ammonia">Amônia (mg/L)</Label>
                    <Input id="ammonia" placeholder="0.15" step="0.01" type="number" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="nitrite">Nitrito (mg/L)</Label>
                    <Input id="nitrite" placeholder="0.08" step="0.01" type="number" />
                  </div>
                  <div className="grid gap-2">
              ...
              <DialogFooter>
                <Button type="submit" onClick={() => setIsAddReadingOpen(false)}>
                  Registrar Leitura
                </Button>
              </DialogFooter>
            </DialogContent>
            ...
            {parameters.map((param, index) => (
              <div key={index} className="border rounded-lg p-4">
                ...
                <div className="text-sm text-muted-foreground space-y-1">
                  <p>Mínimo: {param.min} {param.unit}</p>
                  <p>Máximo: {param.max} {param.unit}</p>
                  <p className="font-medium text-foreground">Ideal: {param.optimal} {param.unit}</p>
                </div>
              </div>
            ))}
          </div>
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{reading.farm}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        {getStatusBadge(reading.status)}
                        <span className="text-xs text-muted-foreground">{reading.timestamp}</span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-lg font-medium">{reading.temperature}</p>
                      ...
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-1 mb-1">
                          ...
                          <span className="text-xs text-muted-foreground">Alc</span>
                        </div>
                        <p className="text-lg font-medium">{reading.alkalinity}</p>
                        <p className="text-xs text-muted-foreground">mg/L</p>
                      </div>
                    </div>
                  </div>
                ...
                <TableBody>
                  {historyReadings.map((reading) => (
                    <TableRow key={reading.id}>
                      ...
                      <TableCell className="font-medium">{reading.nursery}</TableCell>
